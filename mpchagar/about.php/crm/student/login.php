...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT StuID,ID,StudentCourse FROM tblstudent WHERE (UserName=:stuid || StuID=:stuid) and Password=:password";
...
$_SESSION['stucourse']=$result->StudentCourse;
}
...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || Student Login Page</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <!--  <img src="images/logo.svg"> College Fee Payment System-->
                <!--</div>-->
