...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || View Invoice Details</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Invoice Details </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> View Invoice Details</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
<h3 class="mb-35 font-weight-600">     Student Fee Invoice(<?php echo $row->StuID;?>)</h3>
...
<span class="d-block">Date:<span class="pl-10 text-dark"><?php echo $row->InvoiceDate;?></span></span>
...
<tr>
  <th colspan="4" style="font-size:20px; color:blue;text-align: center">Invoice Details</th>

</tr>
<tr><td>1</td><th>Admision Fee</th><td colspan="4"><?php echo $af = ($row->AdmissionFee);?></td></tr>
    <tr><td>2</td><th>SemesterFee</th><td colspan="4"><?php echo $sf=($row->SemesterFee);?></td></tr>
    ...
    <tr><th style="text-align:center;" colspan="2">Remaining Amount</th><td ><?php echo $ra = $tf-$pa ;?></td></tr>                                             
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
