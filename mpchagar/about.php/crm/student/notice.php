...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || View Notice</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">View Notice</h4>
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="view-notice.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-success">View</a>
                                                </div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
