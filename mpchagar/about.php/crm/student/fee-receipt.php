...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || Invoice</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Invoice</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Invoice</a>
                    </div>
...
$sql="SELECT tblfee.* from tblfee where StudentID=:studid LIMIT $offset, $no_of_records_per_page";
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="invoice-detail.php?invoicenumber=<?php echo htmlentities ($row1->InvoiceNumber);?>" class="btn btn-success">View</a></div>
