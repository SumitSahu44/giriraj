...
{               ?>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="student-fee-payment.php">
                <span class="menu-title">Student Fee</span>
                <i class="icon-screen-desktop menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="invoice-generation.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-public-notice.php"> Add Notice </a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="between-dates-reports.php"> Student Report </a></li>
                  <li class="nav-item"> <a class="nav-link" href="between-dates-invoice-reports.php"> Invoice Report </a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth12">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="search-student.php"> Search Student </a></li>
                  <li class="nav-item"> <a class="nav-link" href="search-invoice.php"> Search Invoice </a></li>
                </ul>
              </div>
            </li>
            </li>
