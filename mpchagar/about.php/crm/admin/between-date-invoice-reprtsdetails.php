...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || Between Dates Reports</title>
    <!-- plugins:css -->
...
$sql="SELECT tblfee.* from tblfee where date(tblfee.InvoiceDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
