...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || Manage Notice</title>
    <!-- plugins:css -->
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-public-notice-detail.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-success">View</a>
                                                 <a href="manage-public-notice.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger"> Delete</a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
