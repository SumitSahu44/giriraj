...
<html lang="en">
  <head>
    ...
    <title>College Fee Payment System || Update Notice</title>
    <!-- plugins:css -->
...
{               ?>
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="notmsg" value="" class="form-control" required='true' rows="8"><?php  echo htmlentities($row->NoticeMessage);?></textarea>
                      </div>
                   <?php $cnt=$cnt+1;}} ?>
