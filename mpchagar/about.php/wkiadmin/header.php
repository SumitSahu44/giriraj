   ...
   <nav class="navbar navbar-expand align-items-center gap-4">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                  ...
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu dropdown-option dropdown-menu-end shadow">
                        <div><a class="dropdown-item d-flex align-items-center gap-2 py-2" href="javascript:;">
                            <i class="material-icons-outlined fs-6">inventory_2</i>Archive All</a>
                        </div>
                  ...
                  <div>
                     <a class="dropdown-item border-bottom py-2" href="javascript:;">
                        <div class="d-flex align-items-center gap-3">
                           <div class="">
                              <img src="images/<?= $general['header_logo'];?>" class="rounded-circle" width="45"
                                 height="45" alt="">
                           </div>
                           <div class="">
         ...
         <li class="nav-item dropdown">
            ...
            <img src="images/<?= $general['header_logo'];?>" class="rounded-circle p-1 border" width="45" height="45"alt="<?=$_SESSION['user']['name']?>">
            </a>
            <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
               <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                  <div class="text-center">
                     <img src="images/<?= $general['header_logo'];?>" class=" p-1 shadow mb-3" width="90"
                        height="" alt="<?=$_SESSION['user']['name']?>">
                     <h5 class="user-name mb-0 fw-bold">Hello, <?=$_SESSION['user']['name']?></h5>
                  </div>
               </a>
               <hr class="dropdown-divider">
               ...
               <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="index.php">
