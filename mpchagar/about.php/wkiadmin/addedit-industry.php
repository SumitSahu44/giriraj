<?php 
    ...
    $sql="INSERT INTO `tbl_industry`(`industry_name`, `industry_image`, `industry_desc`, `industry_metatitle`, `industry_metadesc`, `industry_url`, `industry_status`) 
                    VALUES ('$industry_name', '$industry_image', '$industry_desc', '$industry_metatitle', '$industry_metadesc', '$url_link', 'Active')";
    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="manage-industries.php"><button type="button" class="btn btn-primary"><i class="lni lni-arrow-left-circle"></i> Back</button></a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
