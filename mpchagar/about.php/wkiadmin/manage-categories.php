        ...
        <div class="main-content">
          ...
          <a href="javascript:;"><span class="me-1">Failed</span><span class="text-secondary">(42)</span></a>
            ...
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
               <button class="btn btn-filter px-4"><i class="bi bi-box-arrow-right me-2"></i>Delete All Categories</button>
               <button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Categories</button>
            </div>
          </div>
            </div>
            <!--end row-->
                           ...
                           <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img width="50px" style="border-radius:50%;"
                                                src="assets/images/avatars/01.png" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path
                                                    d="M3 6h18M4 10h16M6 4v2M10 4v2M14 4v2M21 8v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8h18z" />
                                            </svg>
                                        </td>
