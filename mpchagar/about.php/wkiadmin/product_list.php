      ...
      <div class="row g-3">
        ...
        <div class="col-auto pb-2">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            <button class="btn btn-primary px-2" onclick="window.location.href='addedit_product.php?category_parent_id=0'">
          ...
          <div class="customer-table">
            <div class="table-responsive white-space-nowrap">
              ...
              <table id="example" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    <?php 
                        $sql = "SELECT * FROM `tbl_category` WHERE category_parent_id=0 ORDER BY category_order_by ASC";
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="product-info">
                          <a href="manage-subproduct.php?category_parent_id=<?= $data['category_id']?>" class="product-title"><?php echo $data['category_name']?></a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <a href="addedit_product.php?category_parent_id=0&category_id=<?php echo $data['category_id']?>"><i class="fadeIn animated bx bx-edit font-20"></i></a>
                    </td>
                    <td>
