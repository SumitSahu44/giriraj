           ...
           echo ("<script>
            window.onload = function() {
                    Swal.fire({
                        ...
                        color: '#fefefe',
                        willClose: () => {
                            window.location.href = 'manage-industries.php';
                        }
                    });
                }
            </script>");
    ...
    <div class="main-content">
      <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Manage Industries Category</div>
            <div class="ms-auto">
          </div>
        </div>
      <!--end breadcrumb-->
      ...
      <div class="row g-3">
        <div class="col-auto pb-2">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            <button class="btn btn-primary px-2" onclick="window.location.href='addedit-industry.php'">
                  <i class="lni lni-circle-plus"></i> Add New Category</button>
          </div>
        </div>
      </div><!--end row-->
          ...
          <div class="customer-table">
            <div class="table-responsive white-space-nowrap">
              ...
              <table id="example" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    <?php 
                        $sql = "SELECT * FROM `tbl_industry` WHERE industry_sub_id='0' ORDER BY industry_order ASC";
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="product-info"><a href="manage-sub-industries.php?industry_sub_id=<?=$data['industry_id']?>"><?php echo $data['industry_name']?></a></div>
                    </td>
                    <td>
                    ...
                    <!--</td>-->
                    <td>
                      <a href="addedit-industry.php?industry_id=<?php echo $data['industry_id']?>"><i class="fadeIn animated bx bx-edit font-20"></i></a>
                    </td>
                    <td>
