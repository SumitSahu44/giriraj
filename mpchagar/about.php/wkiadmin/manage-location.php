           ...
           echo ("<script>
            window.onload = function() {
                    Swal.fire({
                        ...
                        color: '#fefefe',
                        willClose: () => {
                            window.location.href = 'manage-location.php';
                        }
                    });
                }
            </script>");
    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Manage Locations</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-auto pb-2">
                  <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <button class="btn btn-primary px-2" onclick="window.location.href='addedit_location.php'">
                          <i class="lni lni-circle-plus"></i> Add Location</button>
                  </div>
                </div>
            </div><!--end row-->
                    ...
                    <div class="customer-table">
                        <div class="table-responsive white-space-nowrap">
                            ...
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
                                        $sql = "SELECT * FROM `tbl_location` WHERE location_parent_id='0' ORDER BY location_order ASC";
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="manage-sublocation.php?location_parent_id=<?=$data['location_id']?>"><?php echo $data['location_name']?></a></td>
                                        <td>
                                        ...
                                        <td>
                                          <a href="addedit_location.php?location_id=<?php echo $data['location_id']?>"><i class="fadeIn animated bx bx-edit font-20"></i></a>
                                        </td>
                                        <td>
