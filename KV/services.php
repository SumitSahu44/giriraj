        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-6">Providing comprehensive business solutions to help companies thrive in today's competitive environment.</p>
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#c9a560] transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="/services/business-consulting" class="text-gray-400 hover:text-white transition-colors">Business Consulting</a></li>
                        <li><a href="/services/financial-advisory" class="text-gray-400 hover:text-white transition-colors">Financial Advisory</a></li>
                        <li><a href="/services/tax-planning" class="text-gray-400 hover:text-white transition-colors">Tax Planning</a></li>
                        <li><a href="/services/audit-assurance" class="text-gray-400 hover:text-white transition-colors">Audit & Assurance</a></li>
                        <li><a href="/services/company-registration" class="text-gray-400 hover:text-white transition-colors">Company Registration</a></li>
                        <li><a href="/services/gst-services" class="text-gray-400 hover:text-white transition-colors">GST Services</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <div class="w-6 h-6 flex-shrink-0 flex items-center justify-center mt-1">
                                <i class="ri-map-pin-line text-[#c9a560]"></i>
                            </div>
                            <span class="ml-3 text-gray-400">123 Business Avenue, New Delhi, 110001, India</span>
                        </li>
                        <li class="flex items-center">
                            <div class="w-6 h-6 flex-shrink-0 flex items-center justify-center">
                                <i class="ri-phone-line text-[#c9a560]"></i>
                            </div>
                            <span class="ml-3 text-gray-400">+91 98765 43210</span>
                        </li>
                        <li class="flex items-center">
                            <div class="w-6 h-6 flex-shrink-0 flex items-center justify-center">
                                <i class="ri-mail-line text-[#c9a560]"></i>
                            </div>
                            <span class="ml-3 text-gray-400">info@kvassociates.com</span>
                        </li>
                        <li class="flex items-center">
                            <div class="w-6 h-6 flex-shrink-0 flex items-center justify-center">
                                <i class="ri-time-line text-[#c9a560]"></i>
                            </div>
                            <span class="ml-3 text-gray-400">Mon-Fri: 9:00 AM - 6:00 PM</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-800 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-400 text-sm mb-4 md:mb-0">© 2025 KV Associates. All rights reserved.</p>
                    <div class="flex space-x-6">
                        <a href="/privacy-policy" class="text-gray-400 text-sm hover:text-white transition-colors">Privacy Policy</a>
                        <a href="/terms-of-service" class="text-gray-400 text-sm hover:text-white transition-colors">Terms of Service</a>
                        <a href="/sitemap" class="text-gray-400 text-sm hover:text-white transition-colors">Sitemap</a>
                    </div>
                </div>
            </div>
        </div>
